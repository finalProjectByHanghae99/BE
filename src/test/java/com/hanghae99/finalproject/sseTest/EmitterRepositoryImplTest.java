...
class EmitterRepositoryImplTest {
    ...
    void findAllEventCacheStartWithByUserId() throws Exception{
        ...
        Notification notification1 = new Notification(new User(1L), NotificationType.APPLY, "신청이 왔습니다.", "url", false);
        emitterRepository.saveEventCache(eventCacheId1, notification1);

        Thread.sleep(100);
        String eventCacheId2 =  memberId + "_" + System.currentTimeMillis();
        Notification notification2 = new Notification(new User(1L), NotificationType.ACCEPT, "신청이 승인되었습니다.", "url", false);
        emitterRepository.saveEventCache(eventCacheId2, notification2);

        Thread.sleep(100);
        String eventCacheId3 =  memberId + "_" + System.currentTimeMillis();
        Notification notification3 = new Notification(new User(1L), NotificationType.REJECT, "신청이 거절되었습니다.", "url", false);
